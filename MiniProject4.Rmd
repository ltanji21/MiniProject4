...
output: 
  html_document:
    ...
    figure_caption: true
---
![Photo-illustration: Maya Robinson and Photos by Getty Images. Some of the female directors in holywood[^1]](http://pixel.nymag.com/imgs/daily/vulture/2015/11/02/02-female-directors-lede-3.jpg)
...
```
As Charlize Theron defies her cult leader in *Mad Max: Fury Road* and Gal Gadot smashes the god of war in *Wonder Woman*, women seem to have finally found their place in Hollywood. However, the fictional women on screen only shroud the substantial struggle for recognition of the women behind the scenes.[^2] In 2017, [female directors](http://www.vulture.com/2015/10/100-women-directors-hollywood-should-be-hiring.html) are still the marginalized minority.[^3]

Throughout the 20th and 21st century, female directed films have been, at most, 7.9% of films produced each year. These dismal percentages echo the fight against female discrimination throughout history. When the 19th amendment was ratified in 1920, giving women the right to vote, a whopping 5.1% of the movies that year were directed by women. That record was not surpassed again until 1988, or 68 years later, after World War II.[^4] 
...
> “More than any other time in history, that force [feminism] is needed to save this imperiled blue planet. Feminism, for me, is the politics of the 21st century.”[^10]
...
[^8]:https://bechdeltest.com/statistics/
[^9]:https://upload.wikimedia.org/wikipedia/en/b/bf/Dykes_to_Watch_Out_For_%28Bechdel_test_origin%29.jpg
[^10]:https://en.wikipedia.org/wiki/Academy_Award_for_Best_Picture
[^11]:http://time.com/3588846/time-apologizes-feminist-word-poll-robin-morgan/
