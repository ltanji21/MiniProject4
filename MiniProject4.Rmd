...
```{r, warning=FALSE}
#Looking at the table for Oscar winning, female directed movies. 
Oscar_Winners <- c("Awakenings", 
...
Oscars_directors_info <- all_directors_info %>%
  filter(title %in% Oscar_Winners)%>%
  select(production_year, title, name, gender)

"The Piano",  "Little Miss Sunshine", "An Education",
...
**The Ignored Women of Hollywood**
