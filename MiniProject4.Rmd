...
Although the Bechdel test has been used as the framework for much analysis, it is not perfect. Extremely progressive films like [*Brokeback Mountain*](http://www.washingtonpost.com/wp-dyn/content/article/2006/02/01/AR2006020102477.html), detailing a complex homosexual romance, fail the test.  However the test is a good measurement of Hollywood’s treatment of women. Clearly, women need to be more visible and active in the film industry. With this in mind we need to take the force that is feminism and support women in an industry that constantly ignores them. When you can financially support films that have women directing and producing them, and that include women in their narratives.
